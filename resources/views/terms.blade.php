<x-app>
    ...
    <div class="p-5 m-2">
        ...
        <p>
            本利用規約（以下「本規約」と言います。）には、本サービスの提供条件及び当事務局と登録ユーザーの皆様との間の権利義務関係が定められています。本サービスの利用に際しては、本規約の全文をお読みいただいたうえで、本規約に同意いただく必要があります。
        </p>
        <div class="section-name">第1条（適用）</div>
        <p>
        ...
        <div class="section-name">第2条（定義）</div>
        <p>
        ...
        <ol>
            ...
            <li>
                (3)	「投稿データ」とは、登録ユーザーが本サービスを利用して送信するコンテンツ（文章、画像、動画その他のデータを含みますがこれらに限りません。）を意味します。
            </li>
            <li>
                (4)	「当事務局」とは、tododog運営事務局を意味します。
            </li>
            <li>
                (5)	「当事務局ウェブサイト」とは、そのドメインが「todo-dog.herokuapp.com」である、当事務局が運営するウェブサイト（理由の如何を問わず、当事務局のウェブサイトのドメインまたは内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
            </li>
            <li>
        ...
        <div class="section-name">第3条（登録）</div>
        <p>
        ...
        <div class="section-name">第4条（登録事項の変更）</div>
        <p>
            登録ユーザーは、登録事項に変更があった場合、当事務局の定める方法により当該変更事項を遅滞なく当事務局に通知するものとします。
        </p>
        <div class="section-name">第5条（パスワード及びユーザーIDの管理）</div>
        <p>
        ...
        <div class="section-name">第6条（禁止事項）</div>
        <p>
        ...
        <ol>
            ...
            <li>
                (19)	その他、当事務局が不適切と判断する行為
            </li>
        </ol>
        <div class="section-name">第7条（本サービスの停止等）</div>
        <p>
        ...
        <div class="section-name">第8条（権利帰属）</div>
        <p>
        ...
        <div class="section-name">第9条（登録抹消等）</div>
        <p>
        ...
        <div class="section-name">第10条（退会）</div>
        <p>
        ...
        <div class="section-name">第11条（本サービスの内容の変更、終了）</div>
        <p>
        ...
        <div class="section-name">第12条（保証の否認及び免責）</div>
        <p>
        ...
        <p>
            2.	本サービスまたは当事務局ウェブサイトに関連して登録ユーザーと他の登録ユーザーまたは第三者との間において生じた取引、連絡、紛争等については、登録ユーザーが自己の責任によって解決するものとします。
        </p>
        <div class="section-name">第13条（秘密保持）</div>
        <p>
            登録ユーザーは、本サービスに関連して当事務局が登録ユーザーに対して秘密に取扱うことを求めて開示した非公知の情報について、当事務局の事前の書面による承諾がある場合を除き、秘密に取扱うものとします。
        </p>
        <div class="section-name">第14条（利用者情報の取扱い）</div>
        <p>
            1.	当事務局による登録ユーザーの利用者情報の取扱いについては、別途当事務局プライバシーポリシー（https://todo-dog.herokuapp.com/privacy） の定めによるものとし、登録ユーザーはこのプライバシーポリシーに従って当事務局が登録ユーザーの利用者情報を取扱うことについて同意するものとします。
        </p>
        <p>
            2.	当事務局は、登録ユーザーが当事務局に提供した情報、データ等を、個人を特定できない形での統計的な情報として、当事務局の裁量で、利用及び公開することができるものとし、登録ユーザーはこれに異議を唱えないものとします。
        </p>
        <div class="section-name">第15条（本規約等の変更）</div>
        <p>
        ...
        <div class="section-name">第16条（連絡／通知）</div>
        <p>
        ...
        <div class="section-name">第17条（サービス利用契約上の地位の譲渡等）</div>
        <p>
        ...
        <div class="section-name">第18条（分離可能性）</div>
        <p>
            本規約のいずれかの条項またはその一部が、消費者契約法その他の法令等により無効または執行不能と判断された場合であっても、本規約の残りの規定及び一部が無効または執行不能と判断された規定の残りの部分は、継続して完全に効力を有するものとします。
        </p>
        <div class="section-name">第19条（準拠法及び管轄裁判所）</div>
        <p>
